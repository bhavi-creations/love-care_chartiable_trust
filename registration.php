...
<!-- <button onclick="forceDownload()">Download Document</button>

<script>
    function forceDownload() {
        const link = document.createElement('a');
        link.href = "img/documents/Trust_original_documents_2.pdf";
        link.download = "Trust_original_documents_2.pdf";
