...
<div class="page-header">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Education to Children</h2>
            </div>
            <div class="col-12">
                <a href="index.php">Home</a>
                <a href="">Education To Children</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container my-5">
        <div class="row">
            ...
            <div class="col-md-6 col-12">
                ...
                <p>By providing children with proper schooling, we equip them with knowledge and skills that open doors to better career opportunities. Education not only enhances literacy but also fosters problem-solving, creativity, and self-reliance. It enables children to uplift their families and contribute positively to society, leading to long-term economic and social development.
                </p>
                <!-- <p>
